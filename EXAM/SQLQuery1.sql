...
CREATE TABLE PRODUCTS
     (MFR_ID CHAR(3) NOT NULL,/*предприятние*/
  PRODUCT_ID CHAR(5) NOT NULL,
 DESCRIPTION VARCHAR(20) NOT NULL,
       PRICE MONEY NOT NULL,
 QTY_ON_HAND INTEGER NOT NULL,/*кол на складе*/
...
CREATE TABLE OFFICES
     (OFFICE INT NOT NULL,
      ...
      REGION VARCHAR(10) NOT NULL,
         MGR INT,/*менеджер*/
      TARGET DECIMAL(9,2),/*цель*/
       SALES DECIMAL(9,2) NOT NULL,
 PRIMARY KEY (OFFICE));


CREATE TABLE SALESREPS/*сотрудники*/
   (EMPL_NUM INT NOT NULL,/*номер сотрудника*/
             CHECK (EMPL_NUM BETWEEN 101 AND 199),
        NAME VARCHAR(15) NOT NULL,
         AGE INTEGER,
  REP_OFFICE INTEGER,/**/
       TITLE VARCHAR(10),/*заглавие*/
   HIRE_DATE DATE NOT NULL,/*ДАТА НАЙМА*/
     MANAGER INT,
       QUOTA DECIMAL(9,2),/**/
       SALES DECIMAL(9,2) NOT NULL,/*продажи*/
...
CREATE TABLE CUSTOMERS/*заказчики*/
   (CUST_NUM INTEGER    NOT NULL,/*НОМЕР ЗАКАЗЧИКА*/
    COMPANY VARCHAR(20) NOT NULL,
    CUST_REP INTEGER,/*7777*/
...
CREATE TABLE ORDERS/*заказы*/
  ...
  ORDER_DATE DATE NOT NULL,
        CUST INTEGER NOT NULL,
         REP INTEGER,/*номер сотрудника который оформил заказ*/
         MFR CHAR(3) NOT NULL,/*поставщики?*/
     PRODUCT CHAR(5) NOT NULL,
         QTY INTEGER NOT NULL,/*кол заказанных товаров*/
